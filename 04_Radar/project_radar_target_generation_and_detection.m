...
% remains constant
r_0 = 50; % Target initial position (m)
v_0 = 20; % Speed of the target (m/s). It is constant.
...
% Bandwith for the chirp given the space resolution
B = c / (2 * delta_r);  % Chirp bandwith

% Sweep time foreach chirp is defined as rule by 5.5 times of round trip times maximum range
Tchirp = (5.5 * 2 * r_max) / c; % Chirp time (s)

slope = B/Tchirp;   % Signal slope
